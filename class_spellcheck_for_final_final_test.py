...
class SpellChecker:
    ...
    def add_to_trie(self, word, file_path):
        word = word.lower()
        for i in range(len(word)):  # Corrected this line
    ...
    def main(self, excel_file, sheet_name):
        self.read_excel_dict(excel_file, sheet_name)
        self.build_inverted_index()

        while True:
            corrected_query = self.get_corrected_string()
...
if __name__ == "__main__":
    ...
    spell_checker.main('data_and_ids_g_keys.xlsx', 'Version 2')
